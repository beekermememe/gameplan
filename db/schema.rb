...
ActiveRecord::Schema.define(version: 20180415212438) do
  ...
  create_table "tennis_dictionaries", force: :cascade do |t|
    t.string "title"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "ranking"
    t.json "team", default: [], array: true
